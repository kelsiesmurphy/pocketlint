  ...
  return (
    <header className="flex flex-wrap sm:flex-nowrap gap-y-4 justify-between">
        <div className="py-16 px-4 md:px-20 space-y-4 m-auto">
            ...
            <Link to="/products"><button className="bg-slate-700 mt-4 px-4 py-3 hover:text-white hover:bg-slate-800 transition-colors cursor-pointer text-white rounded-none">View products</button></Link>
        </div>
